...
public class Main {
    public static void main(String[] args) {
        ...
        // Published Grades (Name, Band, Grade Points)
        ...
        // This will be extremely inaccurate,
        // but it is the best we can do without knowledge of the points that haven't come out.

        myGrades.add(new EstimatedGrade("IT+ Software Development Project",
                new GradeMap(new ArrayList<>(Arrays.asList(
                        new PercentageTuple("Submission", GradeBand.A1, 100.0)))),10));
        ...
        myGrades.add(new EstimatedGrade("Human Computer Interaction - Design and Evaluation",
                new GradeMap(new ArrayList<>(Arrays.asList(
                        ...
                        new PercentageTuple("Design Fiction", GradeBand.A5, 20.0)))),10));

        myGrades.add(new EstimatedGrade("Software Engineering",
                new GradeMap(new ArrayList<>(Arrays.asList(
                        new PercentageTuple("Assessed Exercise 1", GradeBand.A5, 10.0),
                        new PercentageTuple("Assessed Exercise 1", GradeBand.A5, 20.0)))),15));

        myGrades.add(new EstimatedGrade("Algorithms and Data Structure",
                new GradeMap(new ArrayList<>(Collections.singletonList(
                        new PercentageTuple("Assessed Exercise", GradeBand.A5, 20.0)))),10));
        ...
        myGrades.add(new EstimatedGrade("Advanced Programming",
                new GradeMap(new ArrayList<>(Arrays.asList(
                        ...
                        new PercentageTuple("Class Quiz", GradeBand.A1, 35.0)))),10));
        ...
        myGrades.add(new EstimatedGrade("Internet Technology",
                new GradeMap(new ArrayList<>(Arrays.asList(
                        ...
                        new PercentageTuple("Tango with Django Coursework", GradeBand.A1, 40.0)))),10));
